...
module HPS_mm_interconnect_0 (
	...
	wire    [3:0] rsp_mux_src_channel;                                  // rsp_mux:src_channel -> hps_h2f_axi_master_agent:write_rp_channel
	...
	wire    [3:0] rsp_mux_001_src_channel;                              // rsp_mux_001:src_channel -> hps_h2f_axi_master_agent:read_rp_channel
	...
	wire  [120:0] rsp_mux_002_src_data;                                 // rsp_mux_002:src_data -> hps_h2f_lw_axi_master_agent:write_rp_data
	...
	wire  [120:0] rsp_mux_003_src_data;                                 // rsp_mux_003:src_data -> hps_h2f_lw_axi_master_agent:read_rp_data
	...
	wire  [121:0] onchip_memory_s1_agent_rf_source_data;                // onchip_memory_s1_agent:rf_source_data -> onchip_memory_s1_agent_rsp_fifo:in_data
	...
	wire  [121:0] onchip_memory_s1_agent_rsp_fifo_out_data;             // onchip_memory_s1_agent_rsp_fifo:out_data -> onchip_memory_s1_agent:rf_sink_data
	...
	wire  [120:0] hps_h2f_lw_axi_master_agent_write_cp_data;            // hps_h2f_lw_axi_master_agent:write_cp_data -> router_002:sink_data
	...
	wire  [120:0] hps_h2f_lw_axi_master_agent_read_cp_data;             // hps_h2f_lw_axi_master_agent:read_cp_data -> router_003:sink_data
	...
	wire  [120:0] onchip_memory_s1_agent_rp_data;                       // onchip_memory_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [120:0] cmd_mux_src_data;                                     // cmd_mux:src_data -> onchip_memory_s1_burst_adapter:sink0_data
	...
	wire  [120:0] onchip_memory_s1_burst_adapter_source0_data;          // onchip_memory_s1_burst_adapter:source0_data -> onchip_memory_s1_agent:cp_data
	...
	wire   [33:0] onchip_memory_s1_agent_rdata_fifo_out_data;           // onchip_memory_s1_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	...
	HPS_mm_interconnect_0_router router_002 (
	...
	HPS_mm_interconnect_0_router router_003 (
	...
	HPS_mm_interconnect_0_router_004 router_004 (
	...
	HPS_mm_interconnect_0_cmd_demux cmd_demux_002 (
		.clk                (clk_clk_clk),                                                    //       clk.clk
		.reset              (hps_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	HPS_mm_interconnect_0_cmd_demux cmd_demux_003 (
		.clk                (clk_clk_clk),                                                    //       clk.clk
		.reset              (hps_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	HPS_mm_interconnect_0_rsp_mux rsp_mux_002 (
		.clk                 (clk_clk_clk),                                                    //       clk.clk
		.reset               (hps_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	HPS_mm_interconnect_0_rsp_mux rsp_mux_003 (
		.clk                 (clk_clk_clk),                                                    //       clk.clk
		.reset               (hps_h2f_axi_master_agent_clk_reset_reset_bridge_in_reset_reset), // clk_reset.reset
